    ...
    <HoverCard backgroundColor="#7ee787" direction="" left="0">
      <div className="md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between">
        <p className="text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
          The best way to prepare for a Job Profile is by <span className="text-white font-medium">analysing</span> day-to-day working requirements in multiple org. And keeping the <span className="text-white font-medium">core from everywhere in stack.</span>
        </p>
        <div>
          <a
                ...
                >
                  <pre className="">
                    <span className="code-editor-line-mktg">
                      <span className="pl-s1">programming language core</span>
                    </span>
                  </pre>
                  <pre className="">
                    <motion.span
                  ...
                  >
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-en">&lt;no-sql&gt;</span>
                        <span className="pl-s1">database management system</span>
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-s1">linux and virtualisation</span>.
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-k">[aws]</span>
                        <span className="pl-s1">cloud computing</span>.
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-k">[in python]</span>
                        <span className="pl-s1">machine learning</span>.
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-s1">concept of object oriented programming</span>.
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-k">[hld & lld]</span>
                        <span className="pl-s1">system design</span>.
                      </span>
                    </pre>
                  </motion.div>
                </div>
