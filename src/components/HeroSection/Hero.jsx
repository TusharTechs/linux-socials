      ...
      <div className="flex">
        ...
        <div className=" absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
          <div className="relative md:top-20 mb-[24px]">
            <h3 className="text-white lg:text-[24px] text-center mb-4">
              Internal Interview Database
            </h3>
            <div className="flex justify-center gap-5 items-center">
              <div className="overflow-x-auto mb-0 border-[0.5px] border-[#30363d] rounded-lg">
                <div className="bg-red-600 p-2 text-[#7d8590] tab-nav">
                  <svg
              ...
              <div className="overflow-x-auto mb-0 border-[0.5px] border-[#30363d] rounded-lg">
                <div className="bg-[#161b22] p-2 text-[#7d8590] tab-nav">
                  <svg
              ...
              <div className="overflow-x-auto mb-0 border-[0.5px] border-[#30363d] rounded-lg">
                <div className="bg-[#161b22] p-2 text-[#7d8590] tab-nav">
                  <svg
                    class="w-[24px] h-[24px] text-gray-400 dark:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[36px] font-semibold text-white">
            “The best thing about a rat-race is, even if you win, you are still
            a rat.”
          </h1>
